...
SELECT 
    aut.Institutions AS 同类型院校名称,
    aut.uni_type AS 院校类型
FROM AllUniType aut
INNER JOIN ECNUType et 
    ON aut.uni_type = et.uni_type  
WHERE aut.Institutions != 'East China Normal University'  
ORDER BY 
    aut.uni_type ASC,  
    aut.Institutions ASC;  